...
| Person | Domain | Owns |
|---|---|---|
| _TBD_ | Transit | `ingestion/transit/`, `features/transit/`, `models/transit/` |
| _TBD_ | Energy | `ingestion/energy/`, `features/energy/`, `models/energy/` |
| _TBD_ | Weather & Anomalies | `ingestion/weather/`, `features/weather/`, `models/weather/` |
